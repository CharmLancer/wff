sap.ui.controller("sap.m.sample.PopoverNavCon.C", {
   ...
   onInit : function(evt) {
      ...
      var oModel = new sap.ui.model.json.JSONModel(jQuery.sap.getModulePath(
   ...
   onOpenPopover : function(oEvent) {
      ...
      if (!this._oPopover) {
         this._oPopover = sap.ui.xmlfragment("popoverNavCon",
               "sap.m.sample.PopoverNavCon.Popover", this);
         this.getView().addDependent(this._oPopover);
      }

      // delay because addDependent will do a async rerendering and the popover
